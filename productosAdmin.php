                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                  ...
                                  <input type="hidden" name="accion" value="editar">
                                    <button type="submit" class="btn btn-light text-white me-2"  id="btns">Editar</button>
                                  </form>

                                  <form method="POST" action="php/ProductoController.php">
                                    <input type="hidden" name="accion" value="eliminar">
                                    <input type="hidden" name="idProducto" value="<?php echo $producto_row['idProducto']; ?>">
                                    <button type="submit" class="btn btn-light text-white me-2"  id="btns">Eliminar</button>
                                  </form>
